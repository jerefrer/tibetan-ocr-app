...
class ImagePreview(QGraphicsPixmapItem):
    def __init__(self, image_path: str, line_data: LineData):
        ...
        if self.line_data is not None and len(self.line_data.lines) > 0:
            self.show_preview()
        else:
    ...
    def show_preview(self):
        ...
        for idx, line in enumerate(self.line_data.lines):
            cv2.drawContours(
